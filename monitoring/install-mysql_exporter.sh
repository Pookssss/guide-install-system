...
$sh_c "mysql -u root -e 'create user '\''mysqld_exporter'\''@'\''localhost'\'' identified by '\''mysqld_exporter'\'''"

$sh_c "mysql -u root -e 'grant PROCESS, REPLICATION CLIENT, SELECT on performance_schema.* to '\''mysqld_exporter'\''@'\''localhost'\'''"
